...
export const canReachAndAttack = (attacker: ICreature, target: ICreature, allCreatures: ICreature[], mapData?: { tiles: string[][] }, cols?: number, rows?: number, mapDefinition?: MapDefinition) => 
...
export const calculateDistanceToAttackablePosition = (fromX: number, fromY: number, target: ICreature, creature: ICreature, allCreatures: ICreature[], mapData?: { tiles: string[][] }, cols?: number, rows?: number, mapDefinition?: MapDefinition) => 
...
export const isPositionAccessible = (x: number, y: number, allCreatures: ICreature[], mapData: { tiles: string[][] }, mapDefinition?: MapDefinition) => 
  DistanceSystem.isPositionAccessible(x, y, allCreatures, mapData, mapDefinition);

export const isPositionAccessibleWithBounds = (x: number, y: number, allCreatures: ICreature[], mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition) => 
...
export const isCreatureVisible = (fromX: number, fromY: number, target: ICreature, mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition, options?: LineOfSightOptions, fromCreature?: ICreature, allCreatures?: ICreature[]) => 
  LineOfSightSystem.isCreatureVisible(fromX, fromY, target, mapData, cols, rows, mapDefinition, options, fromCreature, allCreatures);

export const hasLineOfSight = (fromX: number, fromY: number, toX: number, toY: number, mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition, options?: LineOfSightOptions, fromCreature?: ICreature, toCreature?: ICreature, allCreatures?: ICreature[]) => 
...
export const getVisibleCreatures = (fromX: number, fromY: number, allCreatures: ICreature[], mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition, options?: LineOfSightOptions, fromCreature?: ICreature) => 
  LineOfSightSystem.getVisibleCreatures(fromX, fromY, allCreatures, mapData, cols, rows, mapDefinition, options, fromCreature);

export const getReachableTiles = (creature: ICreature, allCreatures: ICreature[], mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition, options?: PathfindingOptions) => 
  PathfindingSystem.getReachableTiles(creature, allCreatures, mapData, cols, rows, mapDefinition, options);

export const findPathToTarget = (startX: number, startY: number, targetX: number, targetY: number, allCreatures: ICreature[], mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition, creature?: ICreature) => 
  PathfindingSystem.findPathToTarget(startX, startY, targetX, targetY, allCreatures, mapData, cols, rows, mapDefinition, creature);

export const calculateStepCost = (fromX: number, fromY: number, toX: number, toY: number, allCreatures: ICreature[], mapData: { tiles: string[][] }, cols: number, rows: number, mapDefinition?: MapDefinition, creature?: ICreature) => 
